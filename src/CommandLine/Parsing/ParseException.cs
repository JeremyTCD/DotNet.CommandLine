...
namespace JeremyTCD.DotNet.CommandLine
{
    ...
    public class ParseException : Exception
    {
        ...
        public ParseException(Exception innerException)
            : base(Strings.ParseException_InvalidArguments, innerException)
        {
        }
        ...
        public ParseException(string userMessage)
            : base(userMessage)
        {
        }
        ...
        public ParseException(string userMessage, Exception innerException)
